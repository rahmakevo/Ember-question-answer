      ...
      typeClass.eachRelationship(function (key, relationship) {
        if (relationship.kind === 'hasMany') {
          ...
          if (!relationshipPayload) {
            ...
            var isEmbedded = _this13.isRelationshipEmbedded(store, typeClass.modelName, relationship);
            if (isEmbedded) {
              (function () {
                var relationshipTypeClass = store.modelFor(relationship.type);
                (0, _lodashCollectionForEach['default'])(relationshipPayload, function (obj, id) {
                  obj.id = id;
                  _this13._updateRecordCacheForType(relationshipTypeClass, obj, store);
                });
              })();
            } else {

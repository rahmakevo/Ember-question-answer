define('ember-bootstrap/components/base/bs-modal', ['exports', 'ember', 'ember-bootstrap/templates/components/bs-modal', 'ember-bootstrap/mixins/transition-support', 'ember-bootstrap/utils/listen-to-cp', 'ember-bootstrap/utils/transition-end'], function (exports, _ember, _emberBootstrapTemplatesComponentsBsModal, _emberBootstrapMixinsTransitionSupport, _emberBootstrapUtilsListenToCp, _emberBootstrapUtilsTransitionEnd) {
  'use strict';
  ...
  exports['default'] = _ember['default'].Component.extend(_emberBootstrapMixinsTransitionSupport['default'], {
    ...
    actions: {
      ...
      submit: function submit() {
        var forms = this.get('modalElement').querySelectorAll('.modal-body form');
        if (forms.length > 0) {
    ...
    show: function show() {
      ...
      var callback = function callback() {
        ...
        if (this.get('usesTransition')) {
          (0, _emberBootstrapUtilsTransitionEnd['default'])(this.get('modalElement'), function () {
            this.takeFocus();
            this.get('onShown')();
